...
local function startBatAimbot()
    ...
    Conns.batAimbot = RunService.Heartbeat:Connect(function()
        ...
        if tHRP and tChar and tHRP.Parent and tChar.Parent then
            ...
            -- CFrame lookAt with -15Â° pitch (OG style)
...
local function rebuildQuickButtons()
    ...
    -- â”€â”€ DRAG directly on the container (no visible handle or lock button) â”€â”€â”€
    local LOCK_H = 0
...
local function setupHotkeys()
    ...
    UIS.InputBegan:Connect(function(input, gameProcessed)
        ...
        -- NOTE: do NOT check gameProcessed here â€” Roblox always marks gamepad buttons
...
local function rebuildUI()
    ...
    -- â”€â”€ HEADER (Aphex Hub style, compact 62px) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    fearBuyerLbl.Text = "âœ¦ Fear Buyer"
    ...
    -- â”€â”€ LEFT SIDEBAR (Shit Script style) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    -- â”€â”€ ROW ORDER & HELPERS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    local rowOrder = {}
    ...
    do
        ...
        -- â”€â”€ FEAR BYPASS BUTTON â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        -- â”€â”€ INSTA RESET BUTTON â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        -- â”€â”€ OPEN ANTI BUTTON â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        makeGap("Bypass", 5)
    ...
    do
        ...
        lbl.Position = UDim2.new(0, 10, 0, 0)
        lbl.BackgroundTransparency = 1
        lbl.Text = "âœ“  Bat Counter â€” Always On"
    ...
    -- â”€â”€ LAGGER TAB â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    do
        makeGap("Bypass", 5)
        ...
        openBtn.Activated:Connect(function()
            ...
            Close2.BackgroundTransparency = 1; Close2.Text = "âœ•"
    ...
    -- â”€â”€ GUI SIZE PICKER â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    do
    ...
    -- â”€â”€ MOVEABLE BUTTONS PICKER â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    do
        local row = Instance.new("Frame", tabPages["Display"])
        row.Size = UDim2.new(1,0,0,52); row.BackgroundColor3 = C_ROW; row.BorderSizePixel = 0
        row.LayoutOrder = LO("Display"); row.ZIndex = 3
    ...
    makeGap("Display", 4)
    -- â”€â”€ BUTTON SIZE PICKER â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    do
        local row = Instance.new("Frame", tabPages["Display"])
    ...
    do
        ...
        local function refreshLockPosBtn()
            lockPosBtn.Text = State.quickLocked and "ðŸ”’  Positions Locked â€” Tap to Unlock" or "ðŸ”“  Lock Button Positions"
    ...
    makeGap("Display", 4)
    -- â”€â”€ RESET BUTTON POSITIONS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    do
        local row = Instance.new("Frame", tabPages["Display"])
        row.Size = UDim2.new(1,0,0,36); row.BackgroundColor3 = C_ROW; row.BorderSizePixel = 0
        row.LayoutOrder = LO("Display"); row.ZIndex = 3
    ...
    do
        ...
        for i, theme in ipairs(THEMES) do
            ...
            selDot.BackgroundTransparency = 1; selDot.Text = "âœ“"
    ...
    UIS.InputBegan:Connect(function(input, gameProcessed)
        ...
        if isClearKey then
            ...
            if isGamepad and reservedPad[kc.Name] then
                ...
                overlaySub.Text = "âš  " .. kc.Name .. " is reserved by Roblox! Pick another button."
    ...
    makeGap("Binds",5)
    do
        local ft = Instance.new("TextLabel", tabPages["Binds"]); ft.Size = UDim2.new(1,0,0,16); ft.BackgroundTransparency = 1; ft.LayoutOrder = LO("Binds"); ft.Text = "fearduels.cc Â· v2.3"; ft.TextColor3 = Color3.fromRGB(60, 60, 75); ft.Font = Enum.Font.Gotham; ft.TextSize = 8; ft.TextXAlignment = Enum.TextXAlignment.Center
    end
    switchTab("Steal")
end
...
local stealProgressGui = (function()
    ...
    -- Main container â€” taller to fit FPS/ping row
    ...
    pingWarnLbl.Text = "âš  WARNING HIGH PING âš "
