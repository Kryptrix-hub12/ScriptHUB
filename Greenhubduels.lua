...
-- ADDED: 3-second green countdown (3â†’2â†’1) when ragdolled
==
--[[
...
local function Main()
    ...
    subTitleLbl.BackgroundTransparency = 1; subTitleLbl.Text = "powered by luck ðŸ€"
    ...
    do
        local page = buildPage("Settings", function()
            ...
            local fl = Instance.new("TextLabel", fw); fl.Size = UDim2.new(1,0,1,0); fl.BackgroundTransparency=1; fl.Text="Green Duels  Â·  powered by luck ðŸ€"; fl.TextColor3=Color3.fromRGB(50,100,65); fl.Font=Enum.Font.Gotham; fl.TextSize=10; fl.TextXAlignment=Enum.TextXAlignment.Center
            ...
            _G._VezyFlashSave = function(success)
                ...
                task.delay(1.5,function() if lbl and lbl.Parent then lbl.Text="Green Duels  Â·  powered by luck ðŸ€"; lbl.TextColor3=Color3.fromRGB(50,100,65) end end)
            end
        end)
        page.LayoutOrder = 6
    end
    ...
    pingIcon.BackgroundTransparency=1; pingIcon.Text="ðŸ“¡"; pingIcon.TextColor3=Color3.fromRGB(180,220,200)
