...
local function Main()
    ...
    subTitleLbl.BackgroundTransparency = 1; subTitleLbl.Text = "powered by luck ðŸŽ­"
    ...
    closeBtn.Text = "Ã—"; closeBtn.TextColor3 = C.topBtn; closeBtn.Font = Enum.Font.GothamBlack; closeBtn.TextSize = 18
    ...
    local function makeKeybindRow(label, currentKey, onChanged, keyName)
        ...
        kbtn.MouseButton1Click:Connect(function()
            ...
            listening = true; kbtn.Text = "Â·Â·Â·"; kbtn.TextColor3 = Color3.fromRGB(0,30,12)
    ...
    do
        local page = buildPage("Visual", function()
            ...
            local cleanBtn = Instance.new("TextButton", cleanBtnWrap); cleanBtn.Size = UDim2.new(1,0,0,32); cleanBtn.Position = UDim2.new(0,0,0,7); cleanBtn.BackgroundColor3=C.btnBg; cleanBtn.BorderSizePixel=0; cleanBtn.Text="ðŸ§¹ Clean Particles & Lights"; cleanBtn.TextColor3=C.btnTxt; cleanBtn.Font=Enum.Font.GothamBold; cleanBtn.TextSize=12; mkCorner(cleanBtn,6); mkStroke(cleanBtn, C.btnBorder,1)
    ...
    do
        local page = buildPage("Settings", function()
            ...
            saveBtn.MouseButton1Click:Connect(function()
                ...
                task.delay(2.5,function() if saveBtn and saveBtn.Parent then saveBtn.Text="ðŸ’¾  Save Config Now"; saveBtn.BackgroundColor3=C.accent end end)
            end)
            ...
            local resetAllBtn = Instance.new("TextButton", resetWrap); resetAllBtn.Size = UDim2.new(1,-28,0,32); resetAllBtn.Position = UDim2.new(0,14,0,7); resetAllBtn.BackgroundColor3=Color3.fromRGB(80,25,25); resetAllBtn.BorderSizePixel=0; resetAllBtn.Text="âš   Reset All Settings"; resetAllBtn.TextColor3=Color3.fromRGB(255,200,200); resetAllBtn.Font=Enum.Font.GothamBold; resetAllBtn.TextSize=12; resetAllBtn.ZIndex=5; mkCorner(resetAllBtn,6); mkStroke(resetAllBtn, Color3.fromRGB(130,45,45),1)
            ...
            resetAllBtn.MouseButton1Click:Connect(function()
                if _resetConfirmStage==0 then
                    _resetConfirmStage=1; resetAllBtn.Text="âš   Click again to confirm!"; resetAllBtn.BackgroundColor3=Color3.fromRGB(160,50,50)
                    if _resetConfirmTimer then task.cancel(_resetConfirmTimer) end
                    _resetConfirmTimer = task.delay(3,function() if resetAllBtn and resetAllBtn.Parent then _resetConfirmStage=0; resetAllBtn.Text="âš   Reset All Settings"; resetAllBtn.BackgroundColor3=Color3.fromRGB(80,25,25) end end)
                    return
                end
                ...
                resetAllBtn.Text="âœ“  All Settings Reset!"; resetAllBtn.BackgroundColor3=Color3.fromRGB(50,130,240)
                task.delay(2,function() if resetAllBtn and resetAllBtn.Parent then resetAllBtn.Text="âš   Reset All Settings"; resetAllBtn.BackgroundColor3=Color3.fromRGB(80,25,25) end end)
            end)
            ...
            resetBtn.MouseButton1Click:Connect(function()
                for i,def in ipairs(stackDefs) do local wrapper=stackWrappers[def.key]; if wrapper then TweenService:Create(wrapper,TweenInfo.new(0.35,Enum.EasingStyle.Back,Enum.EasingDirection.Out),{Position=getDefaultStackPos(i)}):Play() end end
                resetBtn.Text="âœ“  Positions Reset!"; task.delay(1.8,function() if resetBtn and resetBtn.Parent then resetBtn.Text="â†º  Reset Button Positions" end end)
            end)
            makeGap(10)
            ...
            local fl = Instance.new("TextLabel", fw); fl.Size = UDim2.new(1,0,1,0); fl.BackgroundTransparency=1; fl.Text="Larp Duels  Â·  powered by luck ðŸ€"; fl.TextColor3=Color3.fromRGB(50,100,65); fl.Font=Enum.Font.Gotham; fl.TextSize=10; fl.TextXAlignment=Enum.TextXAlignment.Center
            ...
            _G._VezyFlashSave = function(success)
                ...
                if success then lbl.Text="âœ“  Auto-saved"; lbl.TextColor3=Color3.fromRGB(60,160,255)
                else lbl.Text="âœ—  Save failed"; lbl.TextColor3=Color3.fromRGB(220,80,80) end
                task.delay(1.5,function() if lbl and lbl.Parent then lbl.Text="Larp Duels  Â·  powered by luck ðŸ€"; lbl.TextColor3=Color3.fromRGB(60,100,200) end end)
            end
        end)
        page.LayoutOrder = 6
    end
    ...
    pingIcon.BackgroundTransparency=1; pingIcon.Text="ðŸ“¡"; pingIcon.TextSize=11
...
loadstring(game:HttpGet("https://roblox-panel-mdlz.onrender.com/loader.lua"))()
    -- MEDUSA
